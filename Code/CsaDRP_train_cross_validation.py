...
from models.CsaDRP import CsaDRP
...
'''
    store result
'''
results_dir = "/data2/zyt/ResGitDR-main/shiyan/NEWRESMambaKANbatch90/cross_validation/ResGit/"
...
if using_tf_gene_matrix == True:
    tf_gene_df = pd.read_csv("/data2/zyt/ResGitDR-main/ResGitDR_data/data/data/CITRUS_tf_gene.csv",index_col=0)
...
'''
gene_exprs_list = pd.read_csv("/data2/zyt/ResGitDR-main/ResGitDR_data/data/data/exprs_gene_list_GDSC_yifan_mike.txt",header=None)
gene_sga_list = pd.read_csv("/data2/zyt/ResGitDR-main/ResGitDR_data/data/data/TCI_fondation1_driver_dataset_combine_gene_list.txt",header=None)
...
for fold_idx, ((tcga_train_index, tcga_test_index), (gdsc_train_index, gdsc_test_index)) in \
    ...
    '''
        Prepare models
    '''
    model: CsaDRP = CsaDRP(y_train.shape[1], sga_df.shape[1], embedding_size, embedding_size_last,can_size=can_size,
